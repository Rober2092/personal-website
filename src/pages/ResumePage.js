      ...
      <>
        ...
        <div style={style} className="container resume-contain">
          <div className="header">
            <h2 className="display-4">hugo Alvarado</h2>
            ...
            <Col lg={7} class="resume-leftSide">
              <Row>
                <p className="lead">
                  ...
                  <strong>
                    Computer Engineering, healthcare.
                  </strong>
              ...
              <Row>
                ...
                <div class="resume-711">
                  <p>
                    <strong>Ucla </strong>perinatal tech{" "}
                    <span style={{ fontStyle: "italic" }}>
                      Full Stack Web Developer,
                    </span>
                  </p>
                  <p className="highlighted">september2021- Present</p>
                  <p>
                ...
                <div class="resume-cbre">
                  <p>
                    <strong>CBRE, </strong>los angeles -{" "}
                    <span style={{ fontStyle: "italic" }}>
                      Software Engineer.
                    </span>
                  </p>
                ...
                <div class="resume-jands">
                  <p>
                    <strong>freelance </strong>los angeles -{" "}
                ...
                <div class="resume-cedarcide">
                  ...
                  <p className="highlighted">August 2021</p>
                  <p>
                ...
                <div class="resume-freelance">
                  ...
                  <p className="highlighted">November2021 - </p>
                  <p>
              ...
              <Row>
                <h3>Education</h3>
                <p>
                  <strong>University of california los angeles, </strong>Boot Camp -{" "}
                  <span style={{ fontStyle: "italic" }}>
                    Full Stack Web Development
                  </span>
                </p>
                <p className="highlighted">feb 2022 - September 2022</p>
              </Row>
            </Col>
